...
if( file_exists( "videos/".$destination."_gallery" ) )
  {
    echo "<BR>You'll find videos <A href=\"videos.php?destination=".$destination ."\">here.</A>";
  }
?> 
<BR>
			</FONT></P>
...
foreach( $result as $entry ) { 
  ...
  if( $i%2 == 0 )
  {
    ...
    echo "</TD><TD WIDTH=40%>";
    echo "<P><IMG SRC=\"".$details[1]. "\" ALIGN=LEFT HEIGHT=300 BORDER=0><BR></P>";
    echo "</TD></TR>";
  } else {
